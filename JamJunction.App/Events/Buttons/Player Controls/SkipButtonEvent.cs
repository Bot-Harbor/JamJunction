...
/// <summary>
/// Handles the skip button interaction for the audio player.
/// </summary>
/// <remarks>
/// This event is triggered when a user presses the skip button on the
/// player interface. The handler validates the user's voice channel,
/// retrieves the Lavalink player, and skips to the next track in the queue.
/// </remarks>
public class SkipButtonEvent : IButton
{
    ...
    /// </summary>
    /// <remarks>
    /// This property is used to ensure that the user issuing the skip
    ...
    /// <summary>
    /// Executes the skip button interaction logic.
    /// </summary>
    /// <param name="sender">
    ...
    /// </returns>
    /// <remarks>
    /// This method performs several validation checks before skipping playback:
    ...
    /// - Ensures there are additional tracks available in the queue.
    ///
    /// Once validated, the current track is skipped and playback continues
    /// with the next available track.
    /// </remarks>
