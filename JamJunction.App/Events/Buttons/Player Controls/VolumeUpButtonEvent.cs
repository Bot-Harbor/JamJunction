...
/// <summary>
/// Handles the volume up button interaction for the audio player.
/// </summary>
/// <remarks>
/// This event is triggered when a user presses the volume up button on the
/// player interface. The handler validates the user's voice channel,
/// retrieves the Lavalink player instance, increases the playback volume,
...
public class VolumeUpButtonEvent : IButton
{
    ...
    /// <summary>
    /// Executes the volume up button interaction logic.
    /// </summary>
    /// <param name="sender">
    ...
    /// </returns>
    /// <remarks>
    /// This method performs several validation checks before increasing the volume:
    ...
    /// - Ensures the current volume is below the maximum level.
    ///
    /// Once validated, the playback volume is increased and the player
